        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                ...
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Type Edit</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('admin.type.index') }}">All Types</a></li>
                        <li><span>Edit Type - {{ $type->title }}</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Edit Type - {{ $type->title }}</h4>
                                    ...
                                    <div class="tab-pane fade {{ $loop->index == 0 ? 'show active' : '' }}" id="{{ $key }}" role="tabpanel"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text" class="form-control" name="title[{{ $key }}]" value="{{ $type->translations['title'][$key] }}">
                                            </div>
